package com.iamsafi.bottombarfragmentsswitching
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        ...
        supportFragmentManager.fragments.forEach { fragment ->
            Log.i("check", "onBackPressed: ${fragment.javaClass.name}")
            Log.i("check", "onBackPressed: ${fragment.tag}")
            Log.i("check", "onBackPressed: ${fragment.childFragmentManager.backStackEntryCount}")
